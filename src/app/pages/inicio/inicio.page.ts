...
import { IonContent, IonMenuButton, IonHeader, IonTitle, IonToolbar, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCard, IonCardContent, IonButtons, IonAvatar, IonChip, IonButton, IonProgressBar, IonItem } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonItem, IonProgressBar, IonButton, IonChip, IonAvatar, IonButtons, IonMenuButton, IonCardContent, IonCard, IonCardSubtitle, IonCardTitle, IonCardHeader, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class InicioPage implements OnInit {
  ...
  peliculaRecomendada(): void {
    this.http.mostrarRecomendada().subscribe(data => {
